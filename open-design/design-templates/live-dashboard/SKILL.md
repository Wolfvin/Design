...
Emit `<file-edit>` tags for each output file:

```
<file-edit path="index.html">
<!doctype html>
<html>
<!-- single self-contained file, no external CSS / JS imports -->
<!-- beyond a system font stack and a single OD <live-counter> custom element -->
</html>
</file-edit>

<file-edit path="connectors.json">
{
  "bindings": [...],
  "reads": [...]
}
