...
emoji: 🖋️
description: 'Editorial magazine meets e-ink: 10 layouts and 5 palettes (Ink, Indigo
  Porcelain, Forest Ink, Kraft Paper, Dune).'
zh_description: 电子杂志 × 电子墨水; 10 个版面 + 5 套调色板 (墨水/靛蓝瓷/森林墨/牛皮纸/沙丘)
en_description: 'Editorial magazine meets e-ink: 10 layouts and 5 palettes (Ink, Indigo
  Porcelain, Forest Ink, Kraft Paper, Dune).'
category: slides
scenario: marketing
...
od:
  ...
  design_system:
    requires: false
  example_prompt: Use the Guizang Editorial E-Ink Deck template to turn my content
    into an editorial magazine x e-ink horizontal deck with 10 layouts and 5 palettes.
