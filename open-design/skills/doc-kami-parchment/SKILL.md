...
emoji: 📜
description: Warm parchment canvas (#f5f4ed), monochrome ink-blue accent (#1B365D),
  one serif family, and editorial-grade typography.
zh_description: 暖羊皮纸底 (#f5f4ed) + 墨蓝单色 accent (#1B365D) + 单一衬线字体, 编辑级排印
en_description: Warm parchment canvas (#f5f4ed), monochrome ink-blue accent (#1B365D),
  one serif family, and editorial-grade typography.
category: doc
scenario: personal
...
od:
  ...
  example_prompt: Use the Kami Parchment Document template to turn my content into
    a warm parchment document with monochrome ink-blue accents, one serif family,
    and editorial-grade typography. Preserve the template's visual signature, use
