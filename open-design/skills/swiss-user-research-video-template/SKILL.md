...
description: 'Swiss-style user-research narrative template in warm-paper editorial
  aesthetics.
...
od:
  ...
  outputs:
    ...
    - template.html
    - example.html
  example_prompt: Create a Swiss-style user research synthesis deck with premium minimalist
    typography, warm paper tone, a participant donut breakdown, and subtle editorial
    interactions.
