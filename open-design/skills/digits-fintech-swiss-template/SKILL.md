...
description: 'Swiss-grid fintech deck template in black / warm paper / neon-lime contrast.
  ...
  bold numeric cards, restrained motion, and keyboard/click navigation in one HTML
  file.
...
od:
  ...
  outputs:
    ...
    - template.html
    - example.html
  example_prompt: Create a Swiss-grid fintech strategy deck with modular data cards,
    lime accents, and clean keyboard navigation.
