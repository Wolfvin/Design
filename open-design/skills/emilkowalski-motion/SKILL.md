...
description: 'Motion-design follow-up skill inspired by Emil Kowalski''s animation
  guidance. Use after an interface exists to add tasteful micro-interactions, state
  transitions, and page motion with product-grade restraint.
...
od:
  ...
  example_prompt: 'Use emilkowalski-motion on the current React component: add restrained
...
Use this skill after a component file set already exists. The goal is to make the interface feel alive without turning it into a motion demo.
...
4. Use one motion language across the component. Do not mix unrelated easings, durations, or physics.
