...
description: 'Editorial "Field Notes" report template with soft paper background,
  serif hero
...
od:
  ...
  outputs:
    ...
    - template.html
    - example.html
  example_prompt: Create an editorial Field Notes style report with three insight
    cards, key metrics blocks, and a retention line chart in one polished single-file
    HTML page.
