...
emoji: 🎨
description: Locked 1920x1080 canvas deck with React component-level free composition,
  not bound to a fixed template.
zh_description: 锁死 1920×1080 画布, React 组件级自由组合, 不绑模板
en_description: Locked 1920x1080 canvas deck with React component-level free composition,
  not bound to a fixed template.
category: slides
scenario: design
...
od:
  ...
  design_system:
    requires: false
  example_prompt: Use the Open-Slide 1920 Canvas Deck template to turn my content
    into a locked 1920x1080 free-composition deck with React component-level layout.
