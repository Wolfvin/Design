...
description: 'Editorial studio deck template in burgundy / blush / muted-gold palette.
...
od:
  ...
  outputs:
    ...
    - template.html
    - example.html
  example_prompt: Create a premium editorial deck in burgundy and blush with a tag
    cloud slide and an eight-principles card grid.
