...
description: 'Luxury dark-editorial HyperFrames template for three-page cinematic
  storyboards,
...
od:
  ...
  outputs:
    ...
    - template.html
    - example.html
  example_prompt: 'Create a three-page HyperFrames editorial sequence in a dark haute-couture
    style: premium serif typography, magenta accent, elegant chapter transitions,
