---
name: faq-page
description: 'A Frequently Asked Questions (FAQ) page with collapsible accordion sections,
...
3. **Sections**, in order:
   ...
   - **Footer CTA** — "Still have questions?" section with contact link or
     support email.
4. **Write** a set of React component files:
   - Component TSX with React imports, CSS module import, and proper TypeScript types.
   - CSS module file for scoped styles.
   - Types file for component props and data interfaces.
